...
/**
 * Defines how to convert build data to Orchestrate API format.
 */
public interface BuildToOrchestrateAPI {

    /**
     * Converts the given build to the format used by the Orchestrate API.
     *
     * @param sourceKey the key to use to identify this server to the Orchestrate API.
