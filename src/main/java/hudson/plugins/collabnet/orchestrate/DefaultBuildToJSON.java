...
/**
 * Converts a build to JSON for importing as a build activity into Orchestrate.
 */
public class DefaultBuildToJSON implements BuildToJSON {
    Logger logger = Logger.getLogger("net.collab.orchestrate");
    ...
    /**
     * Converts the standard timestamp from Java format to Orchestrate's format.
     *
     *
