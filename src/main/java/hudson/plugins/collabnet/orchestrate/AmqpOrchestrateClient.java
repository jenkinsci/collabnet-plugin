...
/**
 * Client class for communicating builds to Orchestrate using Amqp protocol
 */
public class AmqpOrchestrateClient implements OrchestrateClient {
    ...
    /**
     * Creates an Orchestrate MQ client with default settings
     */
    ...
    /**
     * Creates an Orchestrate MQ client with the given ConnectionFactory (for testing)
