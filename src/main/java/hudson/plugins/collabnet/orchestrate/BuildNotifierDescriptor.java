...
public class BuildNotifierDescriptor extends BuildStepDescriptor<Publisher> {
    ...
    /** The default Orchestrate server URL. */
    ...
    public String getDisplayName() {
        return "Notify TeamForge Orchestrate when a build completes";
    }
    ...
    public boolean configure(StaplerRequest req, JSONObject formData) throws FormException {
        ...
        serverPassword = Secret.fromString(formData.getString("serverPassword"));
        save();
        return super.configure(req,formData);
    }

    /** Gets the URL to the Orchestrate server to connect to. Used by the Jenkins configuration UI. */
     ...
     *
     * @param serverUrl the URL provided by the user
     ...
     *
     * @param sourceKey the key provided by the user
     * @return whether or not the validation succeeded
     */
