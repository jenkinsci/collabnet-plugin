...
public class CNFileRelease extends AbstractTeamForgeNotifier {
    ...
    public static final class DescriptorImpl extends AbstractTeamForgeNotifier.DescriptorImpl {
         ...
         */
        public FormValidation doCheckPkg(CollabNetApp cna, @QueryParameter String project, @QueryParameter String pkg) throws IOException {
        ...
        public FormValidation doCheckRelease(CollabNetApp cna, @QueryParameter String project,
                                             @QueryParameter String pkg, @QueryParameter String release) throws IOException {
         ...
         */
        public ComboBoxModel doFillPkgItems(CollabNetApp cna, @QueryParameter String project) throws IOException {
        ...
        public ComboBoxModel doFillReleaseItems(CollabNetApp cna,
                                                @QueryParameter String project, @QueryParameter("pkg") String _package) throws IOException {
