    ...
    public static class PublishWebhookStepExecution extends SynchNonBlockingStepExecution<Void> {
        ...
        protected Void run() throws Exception {
            ...
            try {
                ...
                BuildNotifier.RadioConfig radioConfig = new BuildNotifier.RadioConfig(webhookUrl, null, null, null, null, null);
                pushNotification.handle(run, radioConfig, null, listener, this.step.status,
