...
package hudson.plugins.orchestrate;
...
public class TestBuildNotifier {
    ...
    public void performDoesNotTryToContactEmptyServer() throws Exception {
        ...
        printer.println("Starting to send build information to TeamForge Orchestrate...");
        printer.println("The URL to the TeamForge Orchestrate server is missing.");
    ...
    /**
     * Since configuration can be modified outside of the Jenkins UI, verify that we don't try to contact the
     * Orchestrate server when the source key is not specified.
     */
    @Test
    public void performDoesNotTryToContactServerWithNoSourceKey() throws Exception {
        ...
        printer.println("Starting to send build information to TeamForge Orchestrate...");
        printer.println("The source key for TeamForge Orchestrate build source is missing.");
    ...
    public void performLogsNotifierActivity() throws Exception {
        ...
        assertTrue("Log should indicate when notifier starts", logOutput.contains("TeamForge Orchestrate Build Notifier - Sending build information"));
        assertTrue("Log should indicate when notifier fails", logOutput.contains("TeamForge Orchestrate Build Notifier - Build information NOT sent"));
    }
}
