...
public class TestEntryFieldsOnPages {
    ...
    @Test
    public void globalConfigurationHasConnectionInfo() throws Exception {
        ...
        WebAssert.assertElementNotPresent(page, "orchestrate-sourceKey");
    }
    ...
    public void configurationHelpHasServerUrlExamples() throws Exception {
        HtmlPage page = webClient.goTo("plugin/Orchestrate-Jenkins-adapter/help-serverUrl.html");
